  ...
  return (
    <div className="max-w-screen-2xl container mx-auto xl:px-24 px-4 md:py-20 py-14">
      <h1 className="text-5xl font-bold text-primary mb-3">
        Find Your
        <span className="text-blue"> New Job </span>
        Today
      </h1>
      ...
      <form>
        <div className="flex justify-start md:flex-row flex-col md:gap-0 gap-4">
          {/* Search Panel */}
          <div
            className="flex md:rounded-s-none rounded-none shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset
         ...
         focus-within:ring-indigo-600 md:w-1/3 w-full"
          ...
          <button
            type="submit"
            className="bg-blue py-2 px-8 text-white md:rounded-s-none "
          >
            Search
          </button>
        </div>
